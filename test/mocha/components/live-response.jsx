  ...
  tests.forEach(function (test) {
    it("passes " + test.expected.request + " to RequestSnippets when showMutatedRequest = " + test.showMutatedRequest, function () {
      ...
      expect(duration.html())
        .toEqual("<div><h5>요청 소요 시간</h5><pre class=\"microlight\">50 ms</pre></div>")
      ...
      expect(responseHeaders.html())
        .toEqual("<div><h5>응답 헤더s</h5><pre class=\"microlight\"><span class=\"headerline\"> content-type: application/xml </span></pre></div>")
    })
  })
})
